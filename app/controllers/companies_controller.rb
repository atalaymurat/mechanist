class CompaniesController < ApplicationController
  ...
  private
    ...
    def company_params
      params.require(:company).permit(:name, :email, :url, :logo, :remote_logo_url,:address_title, :country_id, :state_id, :town, :zip,:address_line, person_ids: [],  people_attributes:[ :first_name, :middle_name, :last_name, :_destroy, :id, :user_id, emails_attributes: [:email, :id, :user_id ] ])
    end
